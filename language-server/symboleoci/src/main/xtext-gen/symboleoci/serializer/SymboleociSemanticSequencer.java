...
public class SymboleociSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == SymboleociPackage.eINSTANCE)
			switch (semanticObject.eClass().getClassifierID()) {
			case SymboleociPackage.ATOM:
				sequence_Atom(context, (Atom) semanticObject); 
				return; 
			case SymboleociPackage.CTYPE:
				sequence_CType(context, (CType) semanticObject); 
				return; 
			case SymboleociPackage.CONTRACT:
				sequence_Contract(context, (Contract) semanticObject); 
				return; 
			case SymboleociPackage.CONTRACT_SPEC:
				sequence_ContractSpec(context, (ContractSpec) semanticObject); 
				return; 
			case SymboleociPackage.DCONCEPT:
				sequence_DConcept(context, (DConcept) semanticObject); 
				return; 
			case SymboleociPackage.DECLAR_PAIR:
	...
	protected void sequence_IntConst(ISerializationContext context, IntConst semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, SymboleociPackage.Literals.INT_CONST__TYPE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, SymboleociPackage.Literals.INT_CONST__TYPE));
		}
	...
	protected void sequence_Name(ISerializationContext context, Name semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, SymboleociPackage.Literals.NAME__NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, SymboleociPackage.Literals.NAME__NAME));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_PointConst(ISerializationContext context, PointConst semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, SymboleociPackage.Literals.POINT_CONST__TYPE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, SymboleociPackage.Literals.POINT_CONST__TYPE));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_cEvent(ISerializationContext context, cEvent semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, SymboleociPackage.Literals.CEVENT__CONTR_EVENT) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, SymboleociPackage.Literals.CEVENT__CONTR_EVENT));
			if (transientValues.isValueTransient(semanticObject, SymboleociPackage.Literals.CEVENT__CONTR_NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, SymboleociPackage.Literals.CEVENT__CONTR_NAME));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getCEventAccess().getContrEventContrEventParserRuleCall_0_0(), semanticObject.getContrEvent());
		feeder.accept(grammarAccess.getCEventAccess().getContrNameContractIDTerminalRuleCall_2_0_1(), semanticObject.eGet(SymboleociPackage.Literals.CEVENT__CONTR_NAME, false));
		feeder.finish();
	}
	...
	protected void sequence_cState(ISerializationContext context, cState semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, SymboleociPackage.Literals.CSTATE__CONTR_STATE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, SymboleociPackage.Literals.CSTATE__CONTR_STATE));
			if (transientValues.isValueTransient(semanticObject, SymboleociPackage.Literals.CSTATE__CONTRACT_NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, SymboleociPackage.Literals.CSTATE__CONTRACT_NAME));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getCStateAccess().getContrStateContrStateParserRuleCall_0_0(), semanticObject.getContrState());
		feeder.accept(grammarAccess.getCStateAccess().getContractNameContractIDTerminalRuleCall_2_0_1(), semanticObject.eGet(SymboleociPackage.Literals.CSTATE__CONTRACT_NAME, false));
		feeder.finish();
	}
	...
	protected void sequence_enumItem(ISerializationContext context, enumItem semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, SymboleociPackage.Literals.ENUM_ITEM__NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, SymboleociPackage.Literals.ENUM_ITEM__NAME));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_oEvent(ISerializationContext context, oEvent semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, SymboleociPackage.Literals.OEVENT__OBL_EVENT) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, SymboleociPackage.Literals.OEVENT__OBL_EVENT));
			if (transientValues.isValueTransient(semanticObject, SymboleociPackage.Literals.OEVENT__OBL_NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, SymboleociPackage.Literals.OEVENT__OBL_NAME));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getOEventAccess().getOblEventOblEventParserRuleCall_0_0(), semanticObject.getOblEvent());
		feeder.accept(grammarAccess.getOEventAccess().getOblNameOblIDTerminalRuleCall_2_0_1(), semanticObject.eGet(SymboleociPackage.Literals.OEVENT__OBL_NAME, false));
		feeder.finish();
	}
	...
	protected void sequence_oState(ISerializationContext context, oState semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, SymboleociPackage.Literals.OSTATE__OBL_STATE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, SymboleociPackage.Literals.OSTATE__OBL_STATE));
			if (transientValues.isValueTransient(semanticObject, SymboleociPackage.Literals.OSTATE__OBL_NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, SymboleociPackage.Literals.OSTATE__OBL_NAME));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getOStateAccess().getOblStateOblStateParserRuleCall_0_0(), semanticObject.getOblState());
		feeder.accept(grammarAccess.getOStateAccess().getOblNameOblIDTerminalRuleCall_2_0_1(), semanticObject.eGet(SymboleociPackage.Literals.OSTATE__OBL_NAME, false));
		feeder.finish();
	}
	...
	protected void sequence_pEvent(ISerializationContext context, pEvent semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, SymboleociPackage.Literals.PEVENT__POW_EVENT) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, SymboleociPackage.Literals.PEVENT__POW_EVENT));
			if (transientValues.isValueTransient(semanticObject, SymboleociPackage.Literals.PEVENT__POW_NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, SymboleociPackage.Literals.PEVENT__POW_NAME));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getPEventAccess().getPowEventPowEventParserRuleCall_0_0(), semanticObject.getPowEvent());
		feeder.accept(grammarAccess.getPEventAccess().getPowNamePowIDTerminalRuleCall_2_0_1(), semanticObject.eGet(SymboleociPackage.Literals.PEVENT__POW_NAME, false));
		feeder.finish();
	}
	...
	protected void sequence_pState(ISerializationContext context, pState semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, SymboleociPackage.Literals.PSTATE__POW_STATE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, SymboleociPackage.Literals.PSTATE__POW_STATE));
			if (transientValues.isValueTransient(semanticObject, SymboleociPackage.Literals.PSTATE__POW_NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, SymboleociPackage.Literals.PSTATE__POW_NAME));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getPStateAccess().getPowStatePowStateParserRuleCall_0_0(), semanticObject.getPowState());
		feeder.accept(grammarAccess.getPStateAccess().getPowNamePowIDTerminalRuleCall_2_0_1(), semanticObject.eGet(SymboleociPackage.Literals.PSTATE__POW_NAME, false));
		feeder.finish();
	}
