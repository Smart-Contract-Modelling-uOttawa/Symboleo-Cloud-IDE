 ...
 * </p>
 * <ul>
 *   <li>{@link symboleoci.symboleoci.impl.oEventImpl#getOblEvent <em>Obl Event</em>}</li>
 *   <li>{@link symboleoci.symboleoci.impl.oEventImpl#getOblName <em>Obl Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class oEventImpl extends MinimalEObjectImpl.Container implements oEvent
{
  ...
  {
    return SymboleociPackage.Literals.OEVENT;
  }
  ...
  public void setOblEvent(String newOblEvent)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SymboleociPackage.OEVENT__OBL_EVENT, oldOblEvent, oblEvent));
  }
  ...
  public Obl getOblName()
  {
    if (oblName != null && oblName.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, SymboleociPackage.OEVENT__OBL_NAME, oldOblName, oblName));
      }
    }
    return oblName;
  }
  ...
  public void setOblName(Obl newOblName)
  {
    ...
    oblName = newOblName;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SymboleociPackage.OEVENT__OBL_NAME, oldOblName, oblName));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SymboleociPackage.OEVENT__OBL_EVENT:
        return getOblEvent();
      case SymboleociPackage.OEVENT__OBL_NAME:
