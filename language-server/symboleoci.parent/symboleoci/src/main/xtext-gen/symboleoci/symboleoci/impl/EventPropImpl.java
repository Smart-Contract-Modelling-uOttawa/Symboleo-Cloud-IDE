 ...
 * </p>
 * <ul>
 *   <li>{@link symboleoci.symboleoci.impl.EventPropImpl#getEventName <em>Event Name</em>}</li>
 *   <li>{@link symboleoci.symboleoci.impl.EventPropImpl#getPoints <em>Points</em>}</li>
 *   <li>{@link symboleoci.symboleoci.impl.EventPropImpl#getOEventName <em>OEvent Name</em>}</li>
 *   <li>{@link symboleoci.symboleoci.impl.EventPropImpl#getCEventName <em>CEvent Name</em>}</li>
 *   <li>{@link symboleoci.symboleoci.impl.EventPropImpl#getPEventName <em>PEvent Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EventPropImpl extends MinimalEObjectImpl.Container implements EventProp
{
  ...
  {
    return SymboleociPackage.Literals.EVENT_PROP;
  }
    ...
    if (eventName != null && eventName.eIsProxy())
    {
      ...
      if (eventName != oldEventName)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, SymboleociPackage.EVENT_PROP__EVENT_NAME, oldEventName, eventName));
      }
    }
    return eventName;
  }
  ...
  public void setEventName(Declar newEventName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SymboleociPackage.EVENT_PROP__EVENT_NAME, oldEventName, eventName));
  }
  ...
  public EList<Point> getPoints()
  {
    if (points == null)
    {
      points = new EObjectContainmentEList<Point>(Point.class, this, SymboleociPackage.EVENT_PROP__POINTS);
    }
    return points;
  }
  ...
  public NotificationChain basicSetOEventName(oEvent newOEventName, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SymboleociPackage.EVENT_PROP__OEVENT_NAME, oldOEventName, newOEventName);
  ...
  public void setOEventName(oEvent newOEventName)
  {
    if (newOEventName != oEventName)
    {
      ...
      if (oEventName != null)
        msgs = ((InternalEObject)oEventName).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SymboleociPackage.EVENT_PROP__OEVENT_NAME, null, msgs);
      if (newOEventName != null)
        msgs = ((InternalEObject)newOEventName).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SymboleociPackage.EVENT_PROP__OEVENT_NAME, null, msgs);
      msgs = basicSetOEventName(newOEventName, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SymboleociPackage.EVENT_PROP__OEVENT_NAME, newOEventName, newOEventName));
  }
  ...
  public NotificationChain basicSetCEventName(cEvent newCEventName, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SymboleociPackage.EVENT_PROP__CEVENT_NAME, oldCEventName, newCEventName);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setCEventName(cEvent newCEventName)
  {
    if (newCEventName != cEventName)
    {
      NotificationChain msgs = null;
      if (cEventName != null)
        msgs = ((InternalEObject)cEventName).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SymboleociPackage.EVENT_PROP__CEVENT_NAME, null, msgs);
      if (newCEventName != null)
        msgs = ((InternalEObject)newCEventName).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SymboleociPackage.EVENT_PROP__CEVENT_NAME, null, msgs);
      msgs = basicSetCEventName(newCEventName, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SymboleociPackage.EVENT_PROP__CEVENT_NAME, newCEventName, newCEventName));
  }
  ...
  public NotificationChain basicSetPEventName(pEvent newPEventName, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SymboleociPackage.EVENT_PROP__PEVENT_NAME, oldPEventName, newPEventName);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setPEventName(pEvent newPEventName)
  {
    if (newPEventName != pEventName)
    {
      NotificationChain msgs = null;
      if (pEventName != null)
        msgs = ((InternalEObject)pEventName).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SymboleociPackage.EVENT_PROP__PEVENT_NAME, null, msgs);
      if (newPEventName != null)
        msgs = ((InternalEObject)newPEventName).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SymboleociPackage.EVENT_PROP__PEVENT_NAME, null, msgs);
      msgs = basicSetPEventName(newPEventName, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SymboleociPackage.EVENT_PROP__PEVENT_NAME, newPEventName, newPEventName));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SymboleociPackage.EVENT_PROP__POINTS:
        return ((InternalEList<?>)getPoints()).basicRemove(otherEnd, msgs);
      case SymboleociPackage.EVENT_PROP__OEVENT_NAME:
        return basicSetOEventName(null, msgs);
      case SymboleociPackage.EVENT_PROP__CEVENT_NAME:
        return basicSetCEventName(null, msgs);
      case SymboleociPackage.EVENT_PROP__PEVENT_NAME:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SymboleociPackage.EVENT_PROP__EVENT_NAME:
