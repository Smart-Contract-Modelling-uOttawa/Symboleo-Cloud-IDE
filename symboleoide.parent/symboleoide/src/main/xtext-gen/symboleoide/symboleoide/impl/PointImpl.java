 ...
 * </p>
 * <ul>
 *   <li>{@link symboleoide.symboleoide.impl.PointImpl#getEventNames <em>Event Names</em>}</li>
 *   <li>{@link symboleoide.symboleoide.impl.PointImpl#getPointConsts <em>Point Consts</em>}</li>
 *   <li>{@link symboleoide.symboleoide.impl.PointImpl#getUnits <em>Units</em>}</li>
 *   <li>{@link symboleoide.symboleoide.impl.PointImpl#getTempOps <em>Temp Ops</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PointImpl extends MinimalEObjectImpl.Container implements Point
{
  ...
  {
    return SymboleoidePackage.Literals.POINT;
  }
  ...
  public EList<SitName> getEventNames()
  {
    if (eventNames == null)
    {
      eventNames = new EObjectContainmentEList<SitName>(SitName.class, this, SymboleoidePackage.POINT__EVENT_NAMES);
    }
    return eventNames;
  }
  ...
  public EList<PointConst> getPointConsts()
  {
    if (pointConsts == null)
    {
      pointConsts = new EObjectContainmentEList<PointConst>(PointConst.class, this, SymboleoidePackage.POINT__POINT_CONSTS);
    }
    return pointConsts;
  }
  ...
  public EList<String> getUnits()
  {
    if (units == null)
    {
      units = new EDataTypeEList<String>(String.class, this, SymboleoidePackage.POINT__UNITS);
    }
    return units;
  }
  ...
  public EList<String> getTempOps()
  {
    if (tempOps == null)
    {
      tempOps = new EDataTypeEList<String>(String.class, this, SymboleoidePackage.POINT__TEMP_OPS);
    }
    return tempOps;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SymboleoidePackage.POINT__EVENT_NAMES:
        return ((InternalEList<?>)getEventNames()).basicRemove(otherEnd, msgs);
      case SymboleoidePackage.POINT__POINT_CONSTS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case SymboleoidePackage.POINT__UNITS:
        return getUnits();
      case SymboleoidePackage.POINT__TEMP_OPS:
        return getTempOps();
    }
