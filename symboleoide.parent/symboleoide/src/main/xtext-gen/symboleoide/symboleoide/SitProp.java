 ...
 * </p>
 * <ul>
 *   <li>{@link symboleoide.symboleoide.SitProp#getSituationName <em>Situation Name</em>}</li>
 *   <li>{@link symboleoide.symboleoide.SitProp#getIntervals <em>Intervals</em>}</li>
 *   <li>{@link symboleoide.symboleoide.SitProp#getOSituationName <em>OSituation Name</em>}</li>
 *   <li>{@link symboleoide.symboleoide.SitProp#getCSituationName <em>CSituation Name</em>}</li>
 *   <li>{@link symboleoide.symboleoide.SitProp#getPSituationName <em>PSituation Name</em>}</li>
 * </ul>
 *
 * @see symboleoide.symboleoide.SymboleoidePackage#getSitProp()
 * @model
 * @generated
 */
public interface SitProp extends EObject
{
   ...
   * @see symboleoide.symboleoide.SymboleoidePackage#getSitProp_SituationName()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link symboleoide.symboleoide.SitProp#getSituationName <em>Situation Name</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see symboleoide.symboleoide.SymboleoidePackage#getSitProp_Intervals()
   ...
   * @see symboleoide.symboleoide.SymboleoidePackage#getSitProp_OSituationName()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link symboleoide.symboleoide.SitProp#getOSituationName <em>OSituation Name</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see symboleoide.symboleoide.SymboleoidePackage#getSitProp_CSituationName()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link symboleoide.symboleoide.SitProp#getCSituationName <em>CSituation Name</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see symboleoide.symboleoide.SymboleoidePackage#getSitProp_PSituationName()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link symboleoide.symboleoide.SitProp#getPSituationName <em>PSituation Name</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
